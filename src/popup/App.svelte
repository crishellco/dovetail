...
{#if currentToken}
  <div class="flex">
    <div class="flex-1 bg-gray-200 appearance-none border-2 border-gray-300 border-r-0 rounded-l w-full py-2 px-4 text-gray-700 leading-tight">
      {currentTokenMasked}
    </div>
    <button
...
{:else}
  ...
  {:else}
    {#if tokenIsInvalid}
    <div class="mb-2 py-2 px-4 bg-red-500 rounded text-white font-semibold tracking-wide">Invalid token</div>
    {/if}
  <div class="flex">
    <div class="flex-1">
      <input
